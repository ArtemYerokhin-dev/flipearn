...
const MyListings = () => {
  ...
  const safeBalance = {
    ...
    withdraw: Number(balance.withdraw ?? 0),
    avaiable: Number(balance.avaiable ?? 0),
  }
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
      ...
      {/* Stats */}
      <div className='mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
        <StatCard
      ...
      <div className='flex flex-col sm:flex-row justify-between gap-4 xl:gap-20 p-6 mb-10 bg-white rounded-xl border border-gray-200'>
        {[
          { label: 'Earned', value: safeBalance.earned, icon: Wallet },
          { label: 'Withdraw', value: safeBalance.withdraw, icon: ArrowDownCircle },
          { label: 'Avaiable', value: safeBalance.avaiable, icon: Coins },
        ].map((item, index) => {
          const Icon = item.icon

          return (
            <div onClick={()=> item.label === "Avaiable" && setShowWithdrawal(true)}
              key={index}
                  ...
                  <div className='space-y-4'>
                    <div className='grid grid-cols-2 gap-2 text-sm'>
                      ...
                      <div>
                        ...
                        <span>{listing.engagament_rate}% engagament</span>
                      </div>
                    </div>
                    ...
                    <div className='flex items-center justify-between pt-3 border-t border-gray-200'>
                        ...
                        <div className='flex items-center space-x-2'>
                          ...
                          <button onClick={()=>navigate(`/edit-listings/${listing.id}`)} className='p-2 border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-indigo-600'>
      ...
      {showCredentialSubmission && (
        <CredentialSubmission listing={setShowCredentialSubmission} onClose={()=> setShowCredentialSubmission(null)}/>
      )}
