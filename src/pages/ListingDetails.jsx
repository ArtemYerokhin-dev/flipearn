...
const ListingDetails = () => {
  ...
  return listing ? (
    <div className='mx-auto min-h-screen px-6 md:p-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex items-center max-md:flex-col gap-10'>
        <div className='flex-1 max-md:w-full'>
          ...
          {images?.length > 0 && (
            <div className='bg-white rounded-xl border border-gray-200 mb-5 overflow-hidden'>
              <div className='p-4'>
                <h4 className='font-semibold text-gray-800'>Screenshots & Proofs</h4>
              </div>
          ...
          <div className='bg-white rounded-xl border border-gray-200 mb-5'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4 text-center'>
              ...
              <div>
                ...
                <p className='font-semibold text-gray-800'>
                  {listing.mounthly_views?.toLocaleString()}
                </p>
                <p className='text-xs text-gray-500'>Mounthly Views</p>
              </div>
              <div>
        ...
        <div className='bg-white min-w-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:mb-10'>
          ...
          <div className='flex items-center text-sm text-gray-600 mb-4'>
            <p>
              Member Since <span className='font-medium'>{new Date(listing.owner?.createdAt).toLocaleString()}</span>
            </p>
          </div>
          <button
            onClick={loadChatbox}
