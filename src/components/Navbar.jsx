...
import { BoxIcon, GripIcon, ListIcon, MenuIcon, MessageCircleCodeIcon, XIcon } from 'lucide-react';
                ...
                <div className='fixed left-0 top-0 right-0 z-100 flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white transition-all'>
                    ...
                    {!user ? (
                        ...
                        <UserButton>
                            ...
                            <UserButton.MenuItems>
                                <UserButton.Action label='Massages' labelIcon={<MessageCircleCodeIcon size={16}/>} onClick={()=> navigate('/messages')}/>
                            </UserButton.MenuItems>
                            <UserButton.MenuItems>
