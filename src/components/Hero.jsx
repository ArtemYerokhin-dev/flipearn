    ...
    return (
        <>
            <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
                ...
                <p className="max-w-xl text-center text-base my-7">A secure market place to buy and sell Instagram, Youtube, Twitter, Telegram and more - fast, safe and hassle-free.</p>
